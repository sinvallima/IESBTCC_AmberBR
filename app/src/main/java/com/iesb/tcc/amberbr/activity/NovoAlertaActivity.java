...
public class NovoAlertaActivity extends AppCompatActivity {
    ...
    public static MainRules amberManager;
    ...
    public void onBackPressed() {
        ...
        NovoAlertaActivity.this.setResult(RESULT_OK, itRetorno);
        NovoAlertaActivity.this.finish();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_novo_alerta, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_novo_alerta, container, false);
